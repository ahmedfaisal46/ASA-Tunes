...
public class Categories_Rock extends GridPane {

      private boolean isHidden;
      private final ClipPlayer clipPlayer;

      public Categories_Rock() {
            isHidden = true;
      ...
      private void addSongs() {
            add(backButton(), 0, 0);
            add(song("./src/audio/tracks/rock/-Blur-Tracy Jacks.mp3"), 0, 1);
            add(song("./src/audio/tracks/rock/-What we're all about-Sum 41.mp3"), 0, 2);
            add(song("./src/audio/tracks/rock/-Wonderwall-Oasis.mp3"), 0, 3);
      }
