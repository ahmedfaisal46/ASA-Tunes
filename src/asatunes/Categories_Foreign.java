...
public class Categories_Foreign extends GridPane {

      private boolean isHidden;
      private final ClipPlayer clipPlayer;

      public Categories_Foreign() {
            isHidden = true;
      ...
      private void addSongs() {
            add(backButton(), 0, 0);
            add(song("./src/audio/tracks/foreign/-PONPONPON-Kyary Pamyu Pamyu.mp3"), 0, 1);
            add(song("./src/audio/tracks/foreign/-Laila Main Laila-Ram Sampath.mp3"), 0, 2);
            add(song("./src/audio/tracks/foreign/-That's Amore-Rocco Granata.mp3"), 0, 3);
      }
