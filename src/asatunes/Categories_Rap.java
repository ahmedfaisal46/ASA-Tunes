...
public class Categories_Rap extends GridPane {

      private boolean isHidden;
      private final ClipPlayer clipPlayer;

      public Categories_Rap() {
            isHidden = true;
      ...
      private void addSongs() {
            add(backButton(), 0, 0);
            add(song("./src/audio/tracks/rap/-Ain't nothin to f wit-Wu Tang.mp3"), 0, 1);
            add(song("./src/audio/tracks/rap/-Hit 'em Up Dirty-Tupac.mp3"), 0, 2);
            add(song("./src/audio/tracks/rap/-Over-Drake.mp3"), 0, 3);
      }
